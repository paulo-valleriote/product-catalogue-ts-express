...
export class OrmProductRepository extends BaseRepository<Product> implements ProductRepository {
  ...
  private get queryBuilder(): SelectQueryBuilder<Product> {
	...
	async findAll(page: number, limit: number): Promise<IResultPagination<GetProductDto>> {
